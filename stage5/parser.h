...
public:
	...
	bool isValidRHS(int tempArrayType[], int tempArraySubType[], string tempArrayLexeme[], int counter);//a method returns boolean value to check if inputs are valid YASL expressions
